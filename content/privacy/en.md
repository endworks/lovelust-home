...
In-app purchases are managed by **RevenueCat**. RevenueCat processes transaction identifiers and purchase history to validate and restore subscriptions. LoveLust does not receive or store your payment card details. See [RevenueCat's Privacy Policy](https://www.revenuecat.com/privacy).

### Anonymous usage analytics

We use **Aptabase** to collect aggregate, anonymous analytics (e.g., which screens are visited, app version, OS). No personal identifiers or health data are included. See [Aptabase's Privacy Policy](https://aptabase.com/legal/privacy).
